...
The mean total number of steps taken per day is **`r formatC(mean_steps_per_day, format="f")`**  
...
```
The maximum 5-minute interval, on average across all the days in the dataset, that contains the maximum number of steps is **`r maximum_steps_interval$interval`** with **`r maximum_steps_interval$steps`** steps
...
The mean total number of steps taken per day is **`r formatC(mean_steps_per_day2, format="f")`**.  
The median total number of steps taken per day is **`r median_steps_per_day2`**.
